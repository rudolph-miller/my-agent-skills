...
| `update-dev-skills` | devフロー、global AGENTS、Worker定義、方針Noteを整合させて更新する。 | `update-dev-skills/` |
| `verify-dev-closeout` | 対象SHAのCI/CD、deploy surface、live readbackを確認する。 | `verify-dev-closeout/` |
